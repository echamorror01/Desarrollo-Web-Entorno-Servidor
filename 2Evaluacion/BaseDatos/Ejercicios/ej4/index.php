...
if (isset($_POST['accion']) && $_POST['accion'] === 'insertar') {
    ...
    if ($codigoArticulo === '' || $seccion === '' || $nombreArticulo === '' || $fecha === '' || $paisDeOrigen === '' || $precio === '') {
...
<head>
    ...
    <title>Ej4 - Listado e inserción de productos</title>
...
<body>
    <div id="barrasuperior">
        ...
        <span class="subtitulo2">Ejercicio4: listado y alta de nuevos productos</span>
    </div>
    ...
    <div id="contenedor">
        ...
        <!-- Formulario único: lista productos y permite insertar en la última fila -->
