...
// Carga la clase Base para obtener y actualizar productos.
require_once __DIR__ . '/../BD.php';

$mensaje = '';
$producto = null;

// Guarda los cambios del producto cuando se envía el formulario.
if (isset($_POST['accion']) && $_POST['accion'] === 'actualizar') {
    ...
    // Carga el producto solicitado desde el listado.
...
<head>
    ...
    <title>Ej6 - Editar producto</title>
...
<body>
    <div id="barrasuperior">
        ...
        <span class="subtitulo2">Ejercicio6: edición del registro seleccionado</span>
    </div>
